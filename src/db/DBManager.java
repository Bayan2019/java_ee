...
public class DBManager {
        ...
        static {
                allNews.add(new News(1L,
                                ...
                                new User("Mirna Alsharif and Austin Mullen"),
                                new Category(1, "culture")));
        ...
        public static ArrayList<News> getSomeNews() {
                return someNews;
        }
