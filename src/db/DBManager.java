...
public class DBManager {
    ...
    static {
        allNews.add(new News(1L,
                ...
                "Mirna Alsharif and Austin Mullen", "culture"));
    ...
    public static ArrayList<News> getCategoryNews(String category) {
        return getAllNews().stream().filter(n -> n.getCategory().equals(category))
