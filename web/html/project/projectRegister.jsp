...
<html>
    ...
    <body>
        ...
        <main>
            <%
                Boolean errorRegister = (Boolean) request.getAttribute("errorRegister");
                if (errorRegister) {
            %>
            ...
            <form action="/project/register" method="post">
                ...
                <input id="projectRegisterEmail" name="projectRegisterEmail" type="text" class="form-control"><br>

                <label for="projectRegisterPassword">PASSWORD* : </label>
                <input id="projectRegisterPassword" name="projectRegisterPassword" type="password" class="form-control"><br>
